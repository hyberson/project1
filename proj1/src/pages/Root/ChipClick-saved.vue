...
<!--                <div class="chip" 
              ...
              ERA @click="chipClickHandler(item.date, time)">
  ...
  console.log('confirmedDateTime.value.date : ', confirmedDateTime.value.date);
  console.log('item.date : ', date);
  console.log('confirmedDateTime.value.time : ', confirmedDateTime.value.time);
...
// const isSlotConfirmed = (date, time) => computed(() => confirmedSlots.value[date] === time);
...
function chipClickHandler(date, time) { // era function chipClickHandler(date, time) {
...
`,
  ...
  ok: {
    ...
    persistent: true
  /* }).onOk(() => {
  // confirmedDateTime.value = { date, time };
  // ="{ 'chip-confirmed': confirmedDateTime.value && confirmedDateTime.value.date === item.date && confirmedDateTime.value.time === time }"
  console.log('---------------- onOK -------------------------------------');
  /* console.log('confirmedDateTime.value : ', confirmedDateTime.value);
  console.log('confirmedDateTime.value.date : ', confirmedDateTime.value.date);
  console.log('item.date : ', date);
